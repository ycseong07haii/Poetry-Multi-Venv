...
from tensorflow_service.containers import TensorFlowContainer
...
def main():
    ...
    # 추론 실행
    print("TensorFlow 모델로 추론을 실행합니다...")
